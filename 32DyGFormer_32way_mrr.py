...
# =============================================================================
# 1. Random Negative Sampler (pure uniform random, no hard negatives)
# =============================================================================
...
# =============================================================================
# 3. Validation — 32-way MRR with random negatives
# =============================================================================

def test_val(model, loader, sampler, val_num_neg=31):
    model.eval()
...
parser.add_argument("--batch_size", type=int, default=64)  # 32-way: batch=64 confirmed OOM-free
...
parser.add_argument("--num_neg", type=int, default=31, help="32-way: 1 pos + 31 neg")
parser.add_argument("--val_num_neg", type=int, default=31)
...
log("=" * 80)
log(f"DyGFormer — 32-way MRR, random negatives (dataset1) — {DATE_STR}")
...
if not args.eval_only:
    log(f"\nTraining — 32-way MRR, random negatives, best selected by MRR...")
    train(
