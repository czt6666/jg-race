...
# =============================================================================
# 0. Repeat Edge Feature Enhancement
# =============================================================================
...
# =============================================================================
# 1. DyGFormer with Recency Features (stacked on repeat features)
# =============================================================================
...
class DyGFormerRecency(DyGFormer):
    ...
    When stacked with repeat edge features, the edge_raw_features already contain
    132 dims (128 base + 4 repeat).  This subclass appends 2 recency dims at
    runtime, yielding a final edge_feat_dim of 134.
    """
...
# =============================================================================
# 2. Multi-Source Hard Negative Sampler (100-way)
# =============================================================================
...
# =============================================================================
# 6. Test Inference (100-way MRR evaluation)
# =============================================================================
...
ALGO_NAME = "DyGFormer_all_features"
...
log("=" * 80)
log(f"DyGFormer + Repeat + Recency + Hard Negatives (dataset1) — {DATE_STR}")
...
log(f"Edge raw dim: {args.edge_feat_dim} (128 + 4 repeat); runtime +2 recency -> total 134")
...
edge_raw_features[1:, :] = enhanced_edge_feat
log(f"Edge raw features shape: {edge_raw_features.shape}")
...
# Use DyGFormerRecency subclass: edge_raw_features is 132-dim (128+4 repeat),
# the subclass appends 2 recency dims at runtime -> total 134
