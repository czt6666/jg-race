...
ALGO_NAME        = "DyGFormer_curriculum_margin"
...
parser.add_argument("--loss",             type=str,   default="margin", choices=["ce", "margin"])
...
log("=" * 80)
log(f"DyGFormer — CURRICULUM + MARGIN ranking loss (warm-start 36) — {DATE_STR}")
