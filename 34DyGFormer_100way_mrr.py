...
ALGO_NAME = "DyGFormer_100way_mrr"
...
log("=" * 80)
log(f"DyGFormer — 100-way MRR, random negatives (dataset1) — {DATE_STR}")
...
if not args.eval_only:
    log(f"\nTraining — 100-way MRR, random negatives, best selected by MRR...")
    train(
