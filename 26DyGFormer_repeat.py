...
def add_repeat_edge_features(src_ids, dst_ids, timestamps, original_edge_feat):
    ...
    :param src_ids: ndarray, shape (num_edges,)
    :param dst_ids: ndarray, shape (num_edges,)
    :param timestamps: ndarray, shape (num_edges,)
    :param original_edge_feat: ndarray or None
    :return: ndarray, shape (num_edges, original_dim + 4)
    """
...
# edge_feat_dim = 128 + 4 (repeat features)
...
log("=" * 80)
log(f"DyGFormer + Repeat Edge Features (dataset1) — {DATE_STR}")
...
log(f"Edge feat dim: {args.edge_feat_dim} (128 + 4 repeat features)")
...
# enhanced_edge_feat shape: (num_edges, 132)
